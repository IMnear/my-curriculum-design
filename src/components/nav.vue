  ...
  <div style="background:while">
    <nav class="nav">
      ...
      <div class="nav__content">
        <ul class="nav__items">
          <li class="nav__item"
              @click="goTowhere ('registration')"> <span class="nav__item-text"> 快速挂号 </span> </li>
          <li class="nav__item"
              @click="goTowhere ('imgPerson')"> <span class="nav__item-text"> 图片问诊 </span> </li>
          <li class="nav__item"
              @click="goTowhere ('news')"> <span class="nav__item-text"> 新闻中心 </span> </li>
          <li class="nav__item"
              @click="goTowhere ('robot')"> <span class="nav__item-text"> 智能导诊 </span> </li>
        </ul>
      </div>
      <label class="nav__btn"
             for="menu-cb"></label>
    </nav>
  </div>
</template>
